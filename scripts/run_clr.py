...
def espupdt():
    try:
        ...
        AccountValidFrom = request.args.get('AccountValidFrom')
        AccountValidTo = request.args.get('AccountValidTo')
        ...
        CustomerSince = request.args.get('CustomerSince')
        ...
        ProdDetValidFrom= request.args.get('ProdDetValidFrom')
        ProdDetValidTo= request.args.get('ProdDetValidTo')
        ...
        JobStartDate= request.args.get('JobStartDate')
    ...
    return make_response(jsonify({'EspUpdate':esp_event2}),200)  
