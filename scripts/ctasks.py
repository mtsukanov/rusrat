...
def post(maxevent):
    ...
    while i==1:
        ...
        for row in cur.fetchall():
            ...
            data = cur.fetchone()
            lasttimereq = data[0]
            if lasttimereq+timedelta(minutes=5) < datetime.now() and row[2] > 85.00:
                ...
                #print k,inputs
                payload3 = {"cid":row[5],"scenario":"":"","beaconid":"","spotid":2,"spotname":"The Store","time":datetime.now(),"trigger":"Luna"}
